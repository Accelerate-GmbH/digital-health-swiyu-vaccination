...
export class PraxisService {
   ...
   * query, is the whole reception desk interaction. The claim list is the
   ...
   * which lot, on which day, by whom. It then has no further hold over the
 ...
 * name. Under its entitlement it cannot obtain them even if its software
