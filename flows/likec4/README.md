...
| --- | --- | --- |
| `index` | n/a | The landscape: patient, four care providers, the governance body, the federal trust infrastructure and the EPD |
| `trustInfrastructureDetail` | n/a | Base Registry and Trust Registry and who talks to which |
...
stays readable and the detail is one click away. That is the convention the reference
model set.
...
The generic mechanics belong to the reference model's `basic-flow`: how a DID is
published, how a token is obtained, how a signature is checked. They are
