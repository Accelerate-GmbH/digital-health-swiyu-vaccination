...
| `profile_status`, `profile_gaps` | Whether the flow runs on the current Swiss Profiles, and which entries in [the gap register](../docs/swiss-profile-gaps.md) it depends on. |
