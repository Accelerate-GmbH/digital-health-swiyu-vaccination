...
**Three rules follow. They are governance rather than cryptography:**
...
- **Retention is the analysis dataset and nothing beside it.** The survey keeps
  ...
  rule is "record nothing that could be recorded". It has to be auditable,
...
1. **Absence is ambiguous, and left unresolved it biases the estimate.** A
   ...
   [F-08](F-08-patient-summary.md) records. It matters more here because the
