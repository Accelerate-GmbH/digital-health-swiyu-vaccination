...
| `dose_number` | Dose number | Numeric | integer, 1 to 20 | FHIR `Immunization.protocolApplied.doseNumberPositiveInt` | required |
| `doses_in_series` | Doses in series | Numeric | integer, 1 to 20 | FHIR `Immunization.protocolApplied.seriesDosesPositiveInt` | required |
| `next_dose_due` | Next dose due | DateTime | string, date | FHIR `Immunization.protocolApplied.series` | n/a |
...
| `site` | Site | Text | string, ≤ 100 chars | FHIR `Immunization.site.text` | n/a |
