...
[`hl7ch/ch-epr-term`](https://github.com/hl7ch/ch-epr-term). They were cloned and read in
...
| Insurance card | `Coverage` over CH Core identifiers | none, because openEHR models the clinical record and cover is not one |
